...
public class Emprestimo1 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jdcCalendarioEmprestimo = new com.toedter.calendar.JDateChooser();
        jButton6 = new javax.swing.JButton();
        jdcCalendarioDevolucao = new com.toedter.calendar.JDateChooser();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(lblNomeLivro, javax.swing.GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
                        .addGap(245, 245, 245))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(52, 52, 52)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jdcCalendarioEmprestimo, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jdcCalendarioDevolucao, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(90, 90, 90))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(jLabel2)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jdcCalendarioEmprestimo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(jLabel3)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jdcCalendarioDevolucao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(10, 10, 10))
    ...
    private void txtIdAlunoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIdAlunoKeyPressed
        if (evt.getKeyCode() == 10) {
            jdcCalendarioEmprestimo.grabFocus();
            pesquisaPessoa();
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, jdcCalendarioEmprestimo.getDate().toString());
    ...
    private com.toedter.calendar.JDateChooser jdcCalendarioDevolucao;
    private com.toedter.calendar.JDateChooser jdcCalendarioEmprestimo;
...
DefaultTableModel modelo;
    ...
    public Emprestimos addEmprestimo() {
        ...
        emprestimo.setDataEmprestimo(DateUtils.convertData(jdcCalendarioEmprestimo.getDate()));
        emprestimo.setDataDevolucao(DateUtils.convertData(jdcCalendarioDevolucao.getDate()));
    ...
    private void limpaCampos() {
        ...
        jdcCalendarioDevolucao.setDate(new Date());
        jdcCalendarioEmprestimo.setDate(new Date());
        txtIDLivro.setText("");

    }

    private void novo() {
        jdcCalendarioDevolucao.setEnabled(true);
        jdcCalendarioEmprestimo.setEnabled(true);
